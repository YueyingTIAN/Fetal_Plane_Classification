...
def main():
    ...
    log = open("vit_b_fetal_planes_finetune.log", "a")
    sys.stdout = log

    checkpoint = torch.load("./vit_b_fetal_plane_generatedNet.pth", weights_only=True)
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './{}Net.pth'.format('vit_b_fetal_plane_finetune')
